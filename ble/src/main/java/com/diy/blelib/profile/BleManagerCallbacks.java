...
public interface BleManagerCallbacks {
	 ...
	 * may ends up with calling {@link #onDeviceNotSupported()} if required services have not been found.
	 */
	...
	/**
	 * Some profiles may use this method to notify user that the link was lost. You must call this method in youe Ble Manager instead of onDeviceDisconnected() while you discover
	 ...
	 *            the error code
	 */
	public void onError(final String message, final int errorCode, boolean hand);
