package com.xs.widgetlib.ww;

/**
 * @version V1.0 <描述当前版本功能>
 * @author: Xs
 * @date: 2016-06-13 16:53
...
public class WaterWaveView extends View {
    ...
    private void init() {
        ...
        progressPaint.setColor(Color.parseColor("#44BB1F24"));
        progressPaint.setAntiAlias(true);

        textPaint = new Paint();
        textPaint.setColor(Color.parseColor("#BB150B"));
        textPaint.setAntiAlias(true);

        circlePaint = new Paint();
        circlePaint.setStyle(Paint.Style.STROKE);
        circlePaint.setAntiAlias(true);
        circlePaint.setColor(Color.parseColor("#BB3126"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text1 = String.valueOf(intProgress);
        //测量文字长度
